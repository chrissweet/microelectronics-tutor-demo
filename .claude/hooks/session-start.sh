...
cat <<'EOF'
<system-reminder>
This project uses the wiki at wiki/microelectronics-tutor-demo.wiki/ as durable memory.
It is a separate git repository with its own remote, NOT a subdirectory of
the main repo. Read SCHEMA_microelectronics-tutor-demo.md before non-trivial wiki edits.
